...
const NaiveTCellIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    {/* "4" label */}
    <text x="12" y="22" fontSize="6" fill="currentColor" textAnchor="middle" fontWeight="bold">
      CD4
    </text>
  </svg>
);
  ...
  const tools = [
    {
      ...
      description:
        'A combined Kanban board, lab notebook, and task management system with Google Drive sync and AI API integrations. Currently in active development and personal use.',
    ...
    },
    {
      ...
      description:
        'Compares effects of Notch signaling on naive CD4 T cells in spleen and mesenteric lymph node.',
    ...
    },
    {
      ...
      description:
        'Analysis of data from Chung et al. showing effects of Notch signaling on alloreactive CD4 T cells.',
    ...
    },
    {
      ...
      description:
        'Lymph node stromal cell transcriptional response to allogeneic vs syngeneic transplant.',
      ...
      <div className="container">
        ...
        <div className="tools-grid">
          {tools.map((tool, index) => (
            ...
            >
              {tool.status && <span className="tool-status-badge">{tool.status}</span>}
